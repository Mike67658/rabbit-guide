...
export const metadata = {
  title: "Mini Satin Rabbit Breed Guide | RabbitBreedGuide.com",
  description:
    "Learn about the Mini Satin rabbit breed, including size, temperament, shiny satin coat, appearance, grooming, care needs, housing, and ownership tips.",
  alternates: {
    canonical: "https://www.rabbitbreedguide.com/rabbits/mini-satin",
  },
  openGraph: {
    title: "Mini Satin Rabbit Breed Guide",
    description:
      "A complete beginner-friendly guide to the Mini Satin rabbit breed.",
    url: "https://www.rabbitbreedguide.com/rabbits/mini-satin",
    siteName: "RabbitBreedGuide.com",
    type: "article",
  },
};

export default function MiniSatinPage() {
  return (
    <div className="min-h-screen bg-[#f7f4ec] text-gray-900">
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-8">
        ...
        <section className="rounded-3xl bg-white border border-emerald-100 shadow-sm overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="bg-emerald-50">
              <img
                src="/rabbits/Mini Satin.png"
                alt="Mini Satin rabbit breed"
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center space-y-5">
              <div className="inline-flex w-fit rounded-full bg-emerald-100 px-4 py-2 text-sm font-semibold text-emerald-800">
                Small Shiny-Coated Rabbit Breed
              </div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                The Mini Satin is a small rabbit breed known for its shiny,
                satin-like coat and friendly personality. This breed has the
                beautiful glossy fur texture of the larger Satin rabbit in a
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          ...
          <p>
            Mini Satins are best known for their glossy coat. The satin fur
            reflects light in a special way, giving the rabbit a bright,
            polished appearance compared with many ordinary short-coated breeds.
          </p>

          <p>
            Many Mini Satins are described as friendly, curious, and pleasant
            when handled gently. Like all rabbits, individual personality can
            vary, but this breed is often appreciated for its attractive coat and
            manageable size.
          </p>

          <p>
            As a small rabbit, the Mini Satin still needs daily care, safe
            housing, proper diet, enrichment, exercise time, gentle grooming, and
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Mini Satins have compact bodies, upright ears, short coats, and a
              shiny satin sheen. Their glossy fur is the breed&apos;s most
              recognizable trait.
            </p>
          </div>
          ...
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Mini Satins need daily hay, fresh water, safe greens, clean
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Shiny satin coat, small size, friendly temperament, compact
                body, and polished appearance.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                ...
                during shedding helps remove loose fur while keeping the satin
                coat smooth.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Mini Satins can work for prepared beginners who understand
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Mini Satins can live indoors with a safe enclosure,
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          <h2 className="text-3xl font-extrabold text-emerald-950">
            Caring for a Mini Satin
          </h2>

          <p>
            A Mini Satin needs unlimited grass hay, fresh water, a clean living
            area, rabbit-safe chew toys, daily exercise, and a safe environment.
            Their small size does not remove the need for enrichment, space, and
            daily attention.
          </p>
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-5">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-1">
              Mini Satins can make good companion rabbits for owners who want a
              small, friendly rabbit and are prepared for proper daily care.
            </p>
          </div>

          <div>
            <h3 className="text-emerald-900 font-bold">
              What makes a Mini Satin&apos;s coat different?
            </h3>
            <p className="text-gray-700 mt-1">
              Mini Satins have a shiny satin coat that reflects light, giving the
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              Do Mini Satins need a lot of grooming?
            </h3>
            <p className="text-gray-700 mt-1">
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              Are Mini Satins good for first-time owners?
            </h3>
            <p className="text-gray-700 mt-1">
