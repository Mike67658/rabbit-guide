...
export const metadata = {
  title: "Himalayan Rabbit Breed Guide | RabbitBreedGuide.com",
  description:
    "Learn about the Himalayan rabbit breed, including size, temperament, dark points, appearance, grooming, care needs, housing, and ownership tips.",
  alternates: {
    canonical: "https://www.rabbitbreedguide.com/rabbits/himalayan",
  },
  openGraph: {
    title: "Himalayan Rabbit Breed Guide",
    description:
      "A complete beginner-friendly guide to the Himalayan rabbit breed.",
    url: "https://www.rabbitbreedguide.com/rabbits/himalayan",
    ...
    <div className="min-h-screen bg-[#f7f4ec] text-gray-900">
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-8">
        ...
        <section className="rounded-3xl bg-white border border-emerald-100 shadow-sm overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="bg-emerald-50">
              <img
                src="/rabbits/Himalayan.png"
                alt="Himalayan rabbit breed"
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center space-y-5">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                The Himalayan Rabbit is a slender small rabbit breed known for
                its white body and dark points on the ears, nose, feet, and
                tail. This breed has a calm personality, distinctive markings,
                and a long, narrow body type that makes it easy to recognize.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-4">
                  ...
                  <div className="font-bold text-emerald-900">Asia</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          ...
          <p>
            Himalayan Rabbits are best known for their clean white body and dark
            points. The nose, ears, feet, and tail are usually darker, creating a
            clear contrast against the white coat.
          </p>

          <p>
            Many Himalayans are described as gentle, calm, and easy to handle
            when treated patiently. Like all rabbits, individual personality can
            vary, but this breed is often appreciated for its relaxed nature.
          </p>

          <p>
            Himalayan Rabbits have a slender body type and need safe housing,
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Himalayans have long narrow bodies, short coats, and dark points
              on the ears, nose, feet, and tail. Their pointed pattern is the
          ...
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              ...
              help a Himalayan Rabbit feel secure.
            </p>
          </div>
          ...
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Himalayan Rabbits need daily hay, fresh water, safe greens, clean
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                White body, dark points, slender body type, gentle temperament,
                and distinctive pointed markings.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Himalayan Rabbits can work for prepared beginners who understand
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Himalayans can live indoors with a safe enclosure,
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          ...
          <p>
            A Himalayan Rabbit needs unlimited grass hay, fresh water, a clean
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-5">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-1">
              Himalayan Rabbits can make good companion rabbits for owners who
              want a gentle, small rabbit and are prepared for proper daily care.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-700 mt-1">
              They are known for a white body with dark points on the ears, nose,
              feet, and tail.
            </p>
          </div>
