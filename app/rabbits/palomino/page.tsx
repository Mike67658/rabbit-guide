...
export const metadata = {
  title: "Palomino Rabbit Breed Guide | RabbitBreedGuide.com",
  description:
    "Learn about the Palomino rabbit breed, including size, temperament, golden coat, appearance, grooming, care needs, housing, and ownership tips.",
  alternates: {
    canonical: "https://www.rabbitbreedguide.com/rabbits/palomino",
  },
  openGraph: {
    title: "Palomino Rabbit Breed Guide",
    description:
      "A complete beginner-friendly guide to the Palomino rabbit breed.",
    url: "https://www.rabbitbreedguide.com/rabbits/palomino",
    siteName: "RabbitBreedGuide.com",
    type: "article",
  },
};

export default function PalominoPage() {
  return (
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-8">
        ...
        <section className="rounded-3xl bg-white border border-emerald-100 shadow-sm overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="bg-emerald-50">
              <img
                src="/rabbits/Palomino.png"
                alt="Palomino rabbit breed"
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center space-y-5">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                The Palomino Rabbit is a large domestic rabbit breed known for
                its warm golden coat, sturdy body, and calm personality. This
                American breed is appreciated for its attractive color,
                manageable temperament, and classic commercial-style build.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                ...
                <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-4">
                  ...
                  <div className="font-bold text-emerald-900">Short / Golden</div>
                </div>
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          <h2 className="text-3xl font-extrabold text-emerald-950">
            About the Palomino Rabbit
          </h2>

          <p>
            Palomino Rabbits are best known for their golden or lynx-colored
            coats. Their warm coloring and sturdy body shape give them a simple,
            attractive, and easy-to-recognize appearance.
          </p>

          <p>
            Many Palominos are described as calm, gentle, and manageable when
          ...
          <p>
            Because Palominos are large rabbits, they need enough room to move
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Palomino Rabbits have large bodies, upright ears, short coats, and
              warm golden coloring. Their sturdy build and rich coat tone are
          ...
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              ...
              help a Palomino Rabbit feel comfortable.
            </p>
          </div>
          ...
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Palomino Rabbits need daily hay, fresh water, safe greens, clean
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Golden coat, large size, calm temperament, sturdy body, and
                classic American rabbit breed appearance.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Palomino Rabbits can be suitable for prepared beginners, but
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Palominos can live indoors with enough room, safe flooring,
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          <h2 className="text-3xl font-extrabold text-emerald-950">
            Caring for a Palomino Rabbit
          </h2>

          <p>
            A Palomino Rabbit needs unlimited grass hay, fresh water, a clean
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-5">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-1">
              Palomino Rabbits can make good companion rabbits for owners who
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              What color is a Palomino Rabbit?
            </h3>
            <p className="text-gray-700 mt-1">
              Palomino Rabbits are known for warm golden coloring, with some
              varieties described as golden or lynx depending on the standard.
            </p>
          </div>

          <div>
            <h3 className="text-emerald-900 font-bold">
              Do Palomino Rabbits need a lot of grooming?
            </h3>
            <p className="text-gray-700 mt-1">
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              Are Palomino Rabbits good for first-time owners?
            </h3>
            <p className="text-gray-700 mt-1">
