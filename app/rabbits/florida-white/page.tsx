...
export const metadata = {
  title: "Florida White Rabbit Breed Guide | RabbitBreedGuide.com",
  description:
    "Learn about the Florida White rabbit breed, including size, temperament, white coat, appearance, grooming, care needs, housing, and ownership tips.",
  alternates: {
    canonical: "https://www.rabbitbreedguide.com/rabbits/florida-white",
  },
  openGraph: {
    title: "Florida White Rabbit Breed Guide",
    description:
      "A complete beginner-friendly guide to the Florida White rabbit breed.",
    url: "https://www.rabbitbreedguide.com/rabbits/florida-white",
    siteName: "RabbitBreedGuide.com",
    type: "article",
  },
};

export default function FloridaWhitePage() {
  return (
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-8">
        ...
        <section className="rounded-3xl bg-white border border-emerald-100 shadow-sm overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <div className="bg-emerald-50">
              <img
                src="/rabbits/Florida White.png"
                alt="Florida White rabbit breed"
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center space-y-5">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                The Florida White is a compact white rabbit breed known for its
                calm temperament, rounded body, short white coat, and red eyes.
                This breed is often appreciated for its manageable size, simple
                appearance, and steady personality.
              </p>
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          <h2 className="text-3xl font-extrabold text-emerald-950">
            About the Florida White
          </h2>

          <p>
            Florida Whites are known for their clean white coat, compact body,
            upright ears, and red eyes. Their simple, balanced appearance makes
            them easy to recognize among small white rabbit breeds.
          </p>

          <p>
            Many Florida Whites are described as calm, gentle, and manageable
            when handled properly. Like all rabbits, individual personality can
            vary, but this breed is often valued for its steady nature.
          </p>

          <p>
            Their smaller size can make them appealing to prepared rabbit owners,
            but Florida Whites still need daily care, safe housing, proper diet,
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Florida Whites have compact bodies, upright ears, short white
              coats, and red eyes. Their clean white appearance and small size
              are the breed&apos;s most recognizable traits.
            </p>
          </div>
          ...
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              ...
              Florida White feel comfortable.
            </p>
          </div>
          ...
          <div className="p-6 bg-white border border-emerald-100 rounded-3xl shadow-sm">
            ...
            <p className="text-gray-700 mt-3 leading-relaxed">
              Florida Whites need daily hay, fresh water, safe greens, clean
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Compact size, white coat, red eyes, calm temperament, rounded
                body, and simple classic rabbit appearance.
              </p>
            </div>
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Florida Whites can work for prepared beginners who understand
            ...
            <div className="rounded-2xl bg-[#faf8f2] border border-emerald-100 p-5">
              ...
              <p className="text-gray-700 mt-2">
                Florida Whites can live indoors with a safe enclosure,
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-4 text-gray-700 leading-relaxed">
          <h2 className="text-3xl font-extrabold text-emerald-950">
            Caring for a Florida White
          </h2>

          <p>
            A Florida White needs unlimited grass hay, fresh water, a clean
        ...
        <section className="p-6 md:p-8 bg-white border border-emerald-100 rounded-3xl shadow-sm space-y-5">
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              Are Florida White rabbits good pets?
            </h3>
            <p className="text-gray-700 mt-1">
              Florida Whites can make good companion rabbits for owners who want
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              What makes Florida White rabbits easy to recognize?
            </h3>
            <p className="text-gray-700 mt-1">
              They are known for their compact body, short white coat, upright
              ears, and red eyes.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              Do Florida Whites need a lot of grooming?
            </h3>
            <p className="text-gray-700 mt-1">
          ...
          <div>
            <h3 className="text-emerald-900 font-bold">
              Are Florida Whites good for first-time owners?
            </h3>
            <p className="text-gray-700 mt-1">
